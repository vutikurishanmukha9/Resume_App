...
# Model files
JOB_CLASSIFIER_PATH = os.path.join(MODELS_DIR, 'job_classifier.pkl')
SALARY_PREDICTOR_PATH = os.path.join(MODELS_DIR, 'salary_predictor.pkl')
RESUME_CLASSIFIER_PATH = os.path.join(MODELS_DIR, 'resume_classifier.pkl')
TFIDF_VECTORIZER_PATH = os.path.join(MODELS_DIR, 'tfidf_vectorizer.pkl')
EMBEDDING_CACHE_FILE = os.path.join(MODELS_DIR, 'job_embeddings_cache.pkl')

# Data files
JOB_DATA_CSV = os.path.join(DATA_DIR, 'job_title_des.csv')
SKILLS_TAXONOMY_PATH = os.path.join(DATA_DIR, 'skills_taxonomy.json')
