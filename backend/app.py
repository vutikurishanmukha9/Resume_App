...
# Import Model Manager (singleton) - DO NOT duplicate this class here
from backend.services.model_manager import model_manager, load_models_background

# Import custom exceptions for standardized error handling
...
# -------------------- MODEL MANAGER (imported from services) --------------------
# ModelManager class is defined in backend/services/model_manager.py
# DO NOT duplicate the class here - use the imported singleton
...
def ready_check():
    ...
    }), 200 if model_manager.is_loaded() else 503
...
@app.errorhandler(ResumeAnalyzerError)
def handle_resume_analyzer_error(error):
