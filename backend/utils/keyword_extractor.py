...
STOP_WORDS: Set[str] = {
    ...
    'structured', 'modular', 'secure', 'automated',
    ...
    'engineered', 'performance', 'automation', 'optimization',
    'security', 'deploy', 'deployments', 'deployment',
    'integration', 'search', 'backend', 'frontend',
    'principles', 'templates', 'validation',
